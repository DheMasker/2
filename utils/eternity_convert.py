...
def eternity_convert(file, config, output, provider_file_enabled=True):
    ...
    all_provider = subs_function.convert_sub(
        "https://raw.githubusercontent.com/soroushmirzaei/telegram-configs-collector/main/protocols/trojan", 'clash', "http://0.0.0.0:25500", False, extra_options="&udp=false")
